...
## [Project.json files](project-model/index.md)
### [Overview](project-model/overview.md)
### [Project.json schema reference](project-model/project-json-reference.md)
### [Global.json schema reference](project-model/global-json-reference.md)
